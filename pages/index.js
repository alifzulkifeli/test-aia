...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section id="career-info">  <div className=' min-h-screen border-4 border-sky-500 text-center grid content-center' > <p className=' text-4xl font-bold ' >Career Info</p> </div></section>
      <section id="saving-investment">  <div className=' min-h-screen border-4 border-sky-500 text-center grid content-center' > <p className=' text-4xl font-bold ' >Saving and Investment</p> </div></section>
